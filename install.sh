...
apt-get install -- yes \
	libxml2-dev libbz2-dev libcurl4-openssl-dev libmcrypt-dev libmhash2 \
	libmhash-dev libpcre3 libpcre3-dev make build-essential libxslt1-dev git \
	libssl-dev nginx git \
	apache2 libapache2-mod-php5 php5 php5-mysql mysql-server phpmyadmin php5-fpm unzip
